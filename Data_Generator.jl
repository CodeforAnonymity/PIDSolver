...
for i in range(1,10000,10000)
    load_pd = [[row[1]+row[1]*Random.rand(Distributions.Normal(0,0.1), 1)[1],row[2]] for row in load_pd_sort]
    load_qd = [[row[1]+row[1]*Random.rand(Distributions.Normal(0,0.1), 1)[1],row[2]]  for row in load_qd_sort]
